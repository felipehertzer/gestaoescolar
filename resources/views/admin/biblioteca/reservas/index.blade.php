...
<div class="container">
    ...
    <h1>Reservas <a href="{{ url('/admin/biblioteca/reservas/create') }}" class="btn btn-primary btn-xs" title="Adicionar reserva"><span class="glyphicon glyphicon-plus" aria-hidden="true"/></a></h1>
    <div class="table">
        <table class="table table-bordered table-striped table-hover">
            ...
            {{-- */$x++;/* --}}
                <tr>
                    ...
                    <td>{{ $item->status }}</td>
                    <td>
                        <a href="{{ url('/admin/biblioteca/reservas/' . $item->id) }}" class="btn btn-success btn-xs" title="Ver reserva"><span class="glyphicon glyphicon-eye-open" aria-hidden="true"/></a>
                        ...
                        {!! Form::open([
                            ...
                            {!! Form::button('<span class="glyphicon glyphicon-trash" aria-hidden="true" title="Apagar reserva" />', array(
                                    'type' => 'submit',
