    ...
    <div class="form-group">
        ...
        <div class="col-sm-6">
            <div class="row">
                ...
                <div class="col-xs-5">
                    {!! Form::select('exemplares_escolhidos[]', $exemplares_escolhidos, null, ['class' => 'form-control', 'size' => '8', 'multiple' => 'multiple', 'id' => 'multiselect_to']) !!}
                </div>
            </div>
        </div>
    </div>
