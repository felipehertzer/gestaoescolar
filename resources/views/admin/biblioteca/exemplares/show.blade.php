...
<div class="container">
    ...
    <h1>exemplare {{ $exemplare->id }}
        <a href="{{ url('admin/biblioteca/exemplares/' . $exemplare->id . '/edit') }}" class="btn btn-primary btn-xs" title="Edit exemplare"><span class="glyphicon glyphicon-pencil" aria-hidden="true"/></a>
        {!! Form::open([
            'method'=>'DELETE',
