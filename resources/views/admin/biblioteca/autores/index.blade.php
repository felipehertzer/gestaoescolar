            ...
            @foreach($autores as $item)
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a href="{{ url('/admin/biblioteca/autores/' . $item->id . '/edit') }}" class="btn btn-primary btn-xs" title="Edit autore"><span class="glyphicon glyphicon-pencil" aria-hidden="true"/></a>
                        {!! Form::open([
                            'method'=>'DELETE',
