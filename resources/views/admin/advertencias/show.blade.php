...
<div class="container">
    ...
    <h1>advertencia {{ $advertencia->id }}
        <a href="{{ url('admin/advertencias/' . $advertencia->id . '/edit') }}" class="btn btn-primary btn-xs" title="Edit advertencia"><span class="glyphicon glyphicon-pencil" aria-hidden="true"/></a>
        {!! Form::open([
            'method'=>'DELETE',
