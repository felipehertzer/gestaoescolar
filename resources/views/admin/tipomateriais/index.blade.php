            ...
            @foreach($tipomateriais as $item)
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a href="{{ url('/admin/tipomateriais/' . $item->id . '/edit') }}" class="btn btn-primary btn-xs" title="Edit tipomateriai"><span class="glyphicon glyphicon-pencil" aria-hidden="true"/></a>
                        {!! Form::open([
                            'method'=>'DELETE',
